...
plugins=(git git-extras bundler brew brew-cask capistrano jump rbenv osx gem rails golang vundle gpg-agent zsh-completions jupyter-completions history-substring-search zsh-autosuggestions web-search wd fzf-z)
